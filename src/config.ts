...
const DEFAULT_CONFIG_TEMPLATE = {
  ...
  subagents: {
    ...
    default_time_budget_sec: null as number | null,
    default_max_turns: null as number | null,
    default_max_total_tokens: null as number | null,
  ...
  .object({
    ...
    subagents: z
      .object({
        ...
        default_time_budget_sec: positiveInt.nullable().default(DEFAULT_CONFIG_TEMPLATE.subagents.default_time_budget_sec),
        default_max_turns: positiveInt.nullable().default(DEFAULT_CONFIG_TEMPLATE.subagents.default_max_turns),
        default_max_total_tokens: positiveInt.nullable().default(DEFAULT_CONFIG_TEMPLATE.subagents.default_max_total_tokens),
